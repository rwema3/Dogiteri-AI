...
class ValidationCubit extends Cubit<FormvalidationState> {
  ...
  String? validatePassword(String? value, [String? firebaseException]) {
    ...
    if (!_hasUpperCase(value)) return 'Password must have at least one uppercase character';
    if (!_hasLowerCase(value)) return 'Password must have at least one lowercase character';
    if (!_hasDigit(value)) return 'Password must have at least one number';
  ...
  String? validateEmail(String? value, [String? firebaseException]) {
    ...
    if (!_hasValidEmail(value)) return 'Please enter a valid email address';
  ...
  String? phoneNumberValidator(String? value) {
    ...
    if (!RegExp(r"^\+?\d{10,12}$").hasMatch(value)) return 'Please enter a valid phone number';
    return null;
  }

  String? heightValidator(String? value) {
    if (value == null || value.isEmpty) return 'Height cannot be empty';
    if (!RegExp(r"^\d+(\.\d+)?$").hasMatch(value)) return 'Please enter a valid height in CM';
    return null;
  }

  String? weightValidator(String? value) {
    if (value == null || value.isEmpty) return 'Weight cannot be empty';
    if (!RegExp(r"^\d+(\.\d+)?$").hasMatch(value)) return 'Please enter a valid weight in KG';
    return null;
  }
  ...
  String? validateDateOfBirth(String? value) {
    ...
    if (!dateFormat.hasMatch(value)) return 'Enter date of birth in the format DD/MM/YYYY';
  ...
  String? validateDay(String? value) {
    if (value == null || value.isEmpty) return 'Day cannot be empty';
    if (!RegExp(r'^\d{2}$').hasMatch(value)) return 'Enter a valid day (DD)';
  ...
  String? validateMonth(String? value) {
    if (value == null || value.isEmpty) return 'Month cannot be empty';
    if (!RegExp(r'^\d{2}$').hasMatch(value)) return 'Enter a valid month (MM)';
  ...
  String? validateYear(String? value) {
    ...
    if (!RegExp(r'^\d{4}$').hasMatch(value)) return 'Enter a valid year (YYYY)';
