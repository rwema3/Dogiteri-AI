# Dogiteri AI  (DR. AI)- Your Medical Assistant
...
```
git clone //github.com/rwema3/Dogiteri-AI
```
...
For any inquiries or support regarding Dr. AI, you can reach out to [info@rwema.com].
